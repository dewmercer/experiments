...
connect_debug_port u_ila_0/clk [get_nets [list sys_clk_IBUF]]
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe0]
set_property port_width 16 [get_debug_ports u_ila_0/probe0]
connect_debug_port u_ila_0/probe0 [get_nets [list {adc/do_out[0]} {adc/do_out[1]} {adc/do_out[2]} {adc/do_out[3]} {adc/do_out[4]} {adc/do_out[5]} {adc/do_out[6]} {adc/do_out[7]} {adc/do_out[8]} {adc/do_out[9]} {adc/do_out[10]} {adc/do_out[11]} {adc/do_out[12]} {adc/do_out[13]} {adc/do_out[14]} {adc/do_out[15]}]]
